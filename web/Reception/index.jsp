<%-- 
    Document   : patientIndex
    Created on : Jun 20, 2015, 4:42:32 PM
    Author     : onekalit
--%>
...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="../scripts/css/plugins/timeline.css" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/App/index.jsp">Uganda Cancer Portal</a>
            </div>
            <!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="https://mail.google.com/mail/u/0/">
                        <i class="fa fa-envelope fa-fw"></i>Mail<i class="fa fa-caret-down"></i>
                    </a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="/app/logout.jsp"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
               ...
               <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="index.html"><i class="fa fa-dashboard fa-fw"></i> Delete Patient</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Registration and Screening Dashboard</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-primary">
                        ...
                        <a href="newpatient.jsp">
                            <div class="panel-footer">
                                <span class="pull-left">  <a href="newpatient.jsp"> <input type="button" value="New Patient" ></a></span> 
